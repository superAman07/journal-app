        ...
        <div className="card p-8 space-y-7 text-center relative overflow-hidden">
          ...
          <div className="space-y-3 pt-1">
            ...
            >
              <button
                type="submit"
                className="w-full py-3 px-4 rounded-xl bg-elevated hover:bg-overlay text-clean font-semibold text-sm border border-border transition-all flex items-center justify-center gap-3 active:scale-[0.98]"
              >
